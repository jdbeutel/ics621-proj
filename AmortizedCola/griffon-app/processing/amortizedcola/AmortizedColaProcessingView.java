...
public class AmortizedColaProcessingView extends AbstractGriffonProcessingView {
    public AmortizedColaModel model;
    public AmortizedColaController controller;

    public void setModel(AmortizedColaModel model) {
        this.model = model;
    }

    public void setController(AmortizedColaController controller) {
